      ...
      <div className="bg-card border border-border rounded-2xl p-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-[18px] font-bold text-foreground">{user.name || "Пользователь"}</h2>
          ...
          <button
            onClick={signOut}
            className="flex items-center gap-1.5 px-3 py-2 text-[12px] text-red-500 hover:bg-red-500/5 rounded-lg transition-colors"
          >
