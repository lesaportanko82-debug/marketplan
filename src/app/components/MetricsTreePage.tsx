...
function AddMetricModal({
  ...
  return (
    <div
      ref={modalRef}
      className="bg-card border border-border rounded-xl p-4 md:p-6 w-full max-w-md shadow-2xl"
      role="dialog"
      aria-modal="true"
...
function MetricDetail({ metric, onClose }: { metric: MetricNode; onClose: () => void }) {
  ...
  return (
    <div className="bg-card border border-[#d4a373]/20 rounded-xl p-4 md:p-6">
